            ...
            <div className="container mx-auto px-4 py-3 lg:py-4">
                <div className="flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex items-center space-x-1">
                        {!isLandingPage && headerProps.navLinks.map((link, index) => (
                            <button
                                key={index}
                    ...
                    <div
                        ...
                        style={{
                            width: `${(() => {
                                ...
                                const totalPaths = headerProps.navLinks.length;
                                const currentIndex = headerProps.navLinks.findIndex(link => link.path === currentPath);
